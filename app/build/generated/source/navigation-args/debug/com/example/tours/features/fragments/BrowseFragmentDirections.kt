...
public class BrowseFragmentDirections private constructor() {
  private data class ToBrowseDetailFragment(
    public val `data`: Tour
  ) : NavDirections {
    public override fun getActionId(): Int = R.id.to_browseDetailFragment
  ...
  public companion object {
    public fun toBrowseDetailFragment(`data`: Tour): NavDirections = ToBrowseDetailFragment(data)
  }
}
