...
public data class SubMainActivityArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): SubMainActivityArgs {
      bundle.setClassLoader(SubMainActivityArgs::class.java.classLoader)
      val __data : Tour?
      ...
      return SubMainActivityArgs(__data)
    }
  }
}
