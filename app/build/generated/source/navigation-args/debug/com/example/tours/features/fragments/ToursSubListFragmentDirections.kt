...
public class ToursSubListFragmentDirections private constructor() {
  private data class ToToursDetailFragment(
    public val `data`: Tour
  ) : NavDirections {
    public override fun getActionId(): Int = R.id.to_toursDetailFragment
  ...
  public companion object {
    public fun toToursDetailFragment(`data`: Tour): NavDirections = ToToursDetailFragment(data)
  }
}
